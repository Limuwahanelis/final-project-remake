...
public class BossMoveToAttackPosState : BossState
{
    ...
    public BossMoveToAttackPosState(Boss boss, BossState nextState) : base(boss)
    {
    ...
    {
        MoveToPosition(_boss.attackPos);
    }
    ...
    void MoveToPosition(Vector3 pos)
    {
        ...
        _boss.ChangeState(new BossNonTargetedBeamAttackState(_boss));
